...
namespace Penguin.Api.Shared
{
    public class SleepPlaylistItem : IPlaylistItem
    {
        ...
        IList<IExecutionCondition> IPlaylistItem.Conditions { get; set; } = new List<IExecutionCondition>();
        public bool Enabled { get; set; }
        public bool Executed { get; }
        public string Id { get; set; }
        public int MaximumWaitMs { get; set; }
        public int MinimumWaitMs { get; set; }
        IList<ITransformation> IPlaylistItem.Transformations { get; set; } = new List<ITransformation>();
